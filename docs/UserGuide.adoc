...
****
Updates the person at the specified `INDEX` with new details.
The index refers to the index number shown in the most recent listing.
...
* `list` +
`update 2 John Doe p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01` +
Updates the 2nd person in the address book with the new details.

* `find Betsy` +
`update 1 Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend` +
Updates the first person in the results of the `find` command with the new details.
